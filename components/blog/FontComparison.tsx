...
const fontPairs = [
  ...
  },
  {
    ...
    css: {
      ...
      body: { fontFamily: "var(--font-ibm-plex-sans)" },
    },
  },
  {
    name: "The Elegant",
        ...
        <AnimatePresence initial={false}>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              execution is just daydreaming. We built this to help you move from
              idea to launch in days, not months. Because the world needs what
              you&apos;re building.
            </p>
          </div>
        </motion.div>
